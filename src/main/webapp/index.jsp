...
<body>	
    ...
    <ul>
        <li><form action="showBook" method="get"><input type="submit" value="Show Books" /></form></li>
        <li><a href="updateBook.jsp">Update Books</a></li>
        <li><a href="deleteBook.jsp">Delete Books</a></li>
        <li><a href="addBook.jsp">Add Books</a></li>
    </ul>
    <ul>
        <li><form action="showAuthor" method="get"><input type="submit" value="Show Authors" /></form></li>
